					...
					<div class="card-body">
						...
						<p>
							<?php if(!isset($item['rent'])): ?>
								...
								<?php endif; ?>
							<?php else: ?>
								<a class="btn btn-sm btn-danger" href="processCart.php?id=<?php echo $key; ?>&subs=increase">+</a>
								<?php echo $_SESSION["cart"]->item($key)->rent; ?> Month(s)
								<?php if($item["rent"] > 3): ?>
								<a class="btn btn-sm btn-danger" href="processCart.php?id=<?php echo $key; ?>&subs=decrease">-</a>
								<?php endif; ?>
							<?php endif; ?>
						</p>
